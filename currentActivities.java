...
public class currentActivities extends javax.swing.JFrame {
 ...
 // get a list of users from mysql database
   public ArrayList<User> getUsersList()
   {
       ...
       try {
           ...
           while(rs.next())
           {
               user = new User(rs.getInt("id"),rs.getString("name"),rs.getInt("idealtime"),rs.getInt("maxtime"));
               usersList.add(user);
           }
       } catch (Exception e) {
           e.printStackTrace();
   ...
   public void executeSQlQuery(String query, String message)
   {
    ...
    private void initComponents() {
        ...
        jTextField_Id.setFont(new java.awt.Font("Helvetica", 0, 14));

        jTextField_FirstName.setFont(new java.awt.Font("Helvetica", 0, 14));
        ...
        jTextField_LastName.setFont(new java.awt.Font("Helvetica", 0, 14)); // NOI18N
        ...
        jTextField_Age.setFont(new java.awt.Font("Helvetica", 0, 14)); // NOI18N
        ...
        jTable_Display_Users.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Activity", "Ideal Time", "Max Time"
            }
        ));
 ...
 // Button Update
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {
       String query = "UPDATE `activities` SET `name`='"+jTextField_FirstName.getText()+"',`idealtime`='"+jTextField_LastName.getText()+"',`maxtime`="+jTextField_Age.getText()+" WHERE `id` = "+jTextField_Id.getText();
 ...
 // Button Delete
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {
        String query = "DELETE FROM `activities` WHERE id = "+jTextField_Id.getText();
